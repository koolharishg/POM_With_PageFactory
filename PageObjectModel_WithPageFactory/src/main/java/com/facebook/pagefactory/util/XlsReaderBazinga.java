...
public class XlsReaderBazinga {
	...
	public XlsReaderBazinga(String path) {
	 ...
	 * 
	 * // System.out.println(filename); Xls_Reader_Bazinga datatable = null;
	 * 
	 * datatable = new Xls_Reader_Bazinga(
